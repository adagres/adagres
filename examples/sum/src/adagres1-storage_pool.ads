...
package Adagres1.Storage_Pool with Preelaborate is
...
private
   ...
   type Storage_Subpool is new Subpools.Root_Subpool with record
      Storage_Memory_Context : Integer; --FFI_Types.Memory_Context;
   end record;

   Default_Storage_Subpool : aliased Storage_Subpool
      :=
       (Subpools.Root_Subpool with Storage_Memory_Context => 254); --Memory_Context.Current_Memory_Context)

end Adagres1.Storage_Pool;
