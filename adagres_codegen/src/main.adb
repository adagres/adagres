         ...
         if Subp.P_Is_Imported then
            ...
            Put_Line
              (Checked_FFI_Adb,
               ...
               "Adagres.Error.Error_Context_Stack := CB;" & "return Result;" &
               "Adagres.Error.PG_exception_stack := Old_JB;" & " else " &
               "Adagres.Error.Error_Context_Stack := CB;" &
               "Raise_Postgres_Error (Preceding_Memory_Context);" & "end if;" & "end " &
